...
public class SimGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        newPanel.setPreferredSize(new Dimension(700, 600));
        ...
        timeInt.setText(timeInt.getText() + Simulator.time.toString());
